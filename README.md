...
- el estudio de la dimensión más adecuada para la variedad,
- y la exploración de la relación entre **spectral embedding** y **spectral clustering** mediante la aplicación de **KMeans**.

Así, no solo presentamos el algoritmo, sino también una comparativa entre las distintas decisiones de modelado y una discusión sobre los resultados obtenidos.

## Estructura del repositorio
- `src/Spectral_embedding.ipynb`: notebook que hemos utilizado para el desarrollo del proyecto. En él incluimos todo el código implementado, incluyendo bastantes explicaciones relevantes.
- `docs/Spectral_embedding.pdf`: presentación del proyecto. Aquí explicamos la mayor parte del trabajo desarrollado en el notebook, así como la metodología llevada a cabo, la teoría detrás del algoritmo, los detalles del dataset y las referencias consultadas.
...
De forma similar, puedes descargar la presentación desde [`docs/Spectral_embedding.pdf`](docs/Spectral_embedding.pdf) y abrirla con tu lector de PDF favorito.
